    ...
    <div className={`bg-white rounded-2xl border border-gray-200 ${className}`}>
      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-7 gap-1 mb-2">
          {daysOfWeek.map(day => (
            <div key={day} className="text-center font-bold text-gray-600 p-2 text-xs md:text-sm font-sans">
              {day}
            </div>
          ))}
        </div>
      ...
      {showTimeSlots && selectedDate && (
        <div className="border-t border-gray-200 p-4">
          <h4 className="font-bold text-gray-800 mb-3 font-handwritten">Available Time Slots</h4>
      ...
      <div className="border-t border-gray-200 p-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
          <div className="flex items-center">
            ...
            <span className="text-gray-600 font-sans">Available</span>
          </div>
          <div className="flex items-center">
            <div className="w-3 h-3 bg-red-100 border border-red-300 rounded mr-2"></div>
            <span className="text-gray-600 font-sans">Booked</span>
          </div>
          <div className="flex items-center">
            <div className="w-3 h-3 bg-blue-100 border border-blue-300 rounded mr-2"></div>
            <span className="text-gray-600 font-sans">Today</span>
          </div>
          <div className="flex items-center">
            <div className="w-3 h-3 bg-gray-100 border border-gray-300 rounded mr-2"></div>
            <span className="text-gray-600 font-sans">Unavailable</span>
          </div>
        </div>
      </div>
    </div>
