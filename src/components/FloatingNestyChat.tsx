    ...
    <>
      ...
      {!isOpen && (
        <div className="fixed bottom-6 right-6 z-50">
          ...
          >
            <img src="/NESTY.svg" alt="NESTY" className="h-8 w-8" />
            
            {/* Floating Caption */}
            <div className="absolute bottom-full right-0 mb-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
              <div className="bg-white text-gray-800 px-4 py-2 rounded-2xl shadow-lg border border-gray-200 whitespace-nowrap font-handwritten text-sm font-bold">
                Talk with NESTY
          ...
          <div className="bg-white rounded-3xl shadow-2xl border border-gray-200 h-full flex flex-col overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-[#CB748E] to-[#698a60] p-4 flex items-center justify-between">
              <div className="flex items-center">
                <img src="/NESTY.svg" alt="NESTY" className="h-6 w-6 mr-3" />
                <div>
                  <h3 className="text-white font-bold font-handwritten">NESTY</h3>
                  {!isMinimized && (
                    <p className="text-white text-opacity-90 text-xs font-sans">Your AI companion</p>
                  )}
                </div>
              </div>
              <div className="flex items-center space-x-2">
                {!isMinimized ? (
                  ...
                  <button
                    onClick={restoreChat}
                    className="text-white hover:bg-white hover:bg-opacity-20 px-3 py-1 rounded-full transition-colors text-sm font-sans"
                  >
                    Restore
                  </button>
                )}
              ...
              <>
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gradient-to-br from-pink-50 via-rose-50 to-green-50">
                  ...
                  <div className="flex flex-col items-center py-6 border-b border-pink-200">
                    <div className="w-28 h-28 bg-gradient-to-br from-pink-200 to-green-200 rounded-full flex items-center justify-center mb-4 shadow-lg border-4 border-white overflow-hidden">
                      <img src="/NESTY.svg" alt="NESTY" className="h-20 w-20" />
                    </div>
                      ...
                      <div className={`flex items-start space-x-3 max-w-xs ${
                        ...
                        <div className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center shadow-md border-2 border-white ${
                          ...
                          {message.type === 'user' ? (
                            ...
                            <img src="/NESTY.svg" alt="NESTY" className="h-4 w-4" />
                          )}
                        </div>
                  ...
                  {isTyping && (
                    <div className="flex justify-start">
                      <div className="flex items-start space-x-3">
                        <div className="flex-shrink-0 w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center shadow-md border-2 border-white">
                          <img src="/NESTY.svg" alt="NESTY" className="h-4 w-4" />
                        </div>
                        <div className="px-4 py-3 rounded-2xl bg-white border-2 border-gray-200 shadow-sm">
                ...
                <div className="border-t border-pink-200 p-4 bg-gradient-to-r from-pink-50 to-green-50">
                  <div className="flex space-x-3 items-end">
                    <textarea
                      ...
                      className="flex-1 border-2 border-pink-300 rounded-2xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-pink-400 focus:border-transparent resize-none bg-white bg-opacity-95 text-sm font-sans shadow-md backdrop-blur-sm"
                      rows={2}
                    />
                    <button
