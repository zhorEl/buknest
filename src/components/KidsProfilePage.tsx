      ...
      {showAddChildForm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-3xl shadow-xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center p-6 border-b border-gray-200">
              <h2 className="text-3xl font-bold text-gray-900 font-handwritten">Add New Child</h2>
              <button
              ...
              <div className="grid lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full border-2 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#CB748E] focus:border-transparent font-sans ${
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          ...
                          {formErrors.dateOfBirth && (
                            <div className="text-red-600 text-sm mt-1">{formErrors.dateOfBirth}</div>
                          )}
                        </div>
                  ...
                  <div className="bg-white border border-gray-200 rounded-2xl p-6">
                    ...
                    <div className="space-y-6">
                      {/* Conditions */}
                      <div>
                        <label className="block text-sm font-bold text-gray-700 mb-2 font-sans">Conditions/Diagnoses</label>
                        <div className="flex flex-wrap gap-2 mb-3">
                          {newChildData.conditions.map((condition, index) => (
                            <div key={index} className="flex items-center px-3 py-1 bg-pink-100 text-[#CB748E] rounded-full text-sm font-semibold font-sans">
                              <span>{condition}</span>
                              <button
                        ...
                        <input
                          ...
                          value={newCondition}
                          onChange={(e) => setNewCondition(e.target.value)}
                          onKeyPress={(e) => e.key === 'Enter' && addToArray('conditions', newCondition, setNewCondition)}
                          placeholder="Or type custom condition..."
                          className="w-full mt-2 border-2 border-gray-300 rounded-xl px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#CB748E] focus:border-transparent font-sans"
                        />
                      </div>

                      {/* Allergies */}
                      <div>
                        <label className="block text-sm font-bold text-gray-700 mb-2 font-sans">Allergies</label>
                        <div className="flex flex-wrap gap-2 mb-3">
                          {newChildData.allergies.map((allergy, index) => (
                            <div key={index} className="flex items-center px-3 py-1 bg-red-100 text-red-800 rounded-full text-sm font-semibold font-sans">
                              <span>{allergy}</span>
                              <button
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2 mb-3">
                          {newChildData.medications.map((medication, index) => (
                        ...
                        <div className="flex space-x-2">
                          <input
                            ...
                            onKeyPress={(e) => e.key === 'Enter' && addToArray('medications', newMedication, setNewMedication)}
                  ...
                  <div className="bg-white border border-gray-200 rounded-2xl p-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-sm font-bold text-gray-700 mb-2 font-sans">Name *</label>
                        <input
                          type="text"
                        ...
                        {formErrors.emergencyContactName && (
                          <div className="text-red-600 text-sm mt-1">{formErrors.emergencyContactName}</div>
                        )}
                      </div>
                      
                      <div>
                        <label className="block text-sm font-bold text-gray-700 mb-2 font-sans">Relationship</label>
                        <select
                      ...
                      <div>
                        <label className="block text-sm font-bold text-gray-700 mb-2 font-sans">Phone *</label>
                        <input
                          type="tel"
                        ...
                        {formErrors.emergencyContactPhone && (
                          <div className="text-red-600 text-sm mt-1">{formErrors.emergencyContactPhone}</div>
                        )}
                      </div>
                      
                      <div>
                        <label className="block text-sm font-bold text-gray-700 mb-2 font-sans">Email</label>
                        <input
                          type="email"
                          value={newChildData.emergencyContact.email}
                ...
                <div className="space-y-8">
                  ...
                  <div className="bg-white border border-gray-200 rounded-2xl p-6">
                    ...
                    <div className="space-y-4">
                      <div>
                        <label className="block text-sm font-bold text-gray-700 mb-2 font-sans">Doctor Name</label>
                        <input
                          type="text"
                          value={newChildData.pediatrician.name}
                      ...
                      <div>
                        ...
                        <input
                          type="tel"
                          value={newChildData.pediatrician.phone}
                      ...
                      <div>
                        <label className="block text-sm font-bold text-gray-700 mb-2 font-sans">Clinic/Hospital</label>
                        <input
                          type="text"
                          value={newChildData.pediatrician.clinic}
                          onChange={(e) => handleInputChange('pediatrician.clinic', e.target.value)}
                          className="w-full border-2 border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#CB748E] focus:border-transparent font-sans"
                          placeholder="Children's Medical Center"
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white border border-gray-200 rounded-2xl p-6">
                    <h3 className="text-xl font-bold text-gray-800 mb-6 font-handwritten flex items-center">
                      <BookOpen className="h-5 w-5 mr-2 text-[#CB748E]" />
                      School Information
                    </h3>
                    
                    <div className="space-y-4">
                      <div>
                        <label className="block text-sm font-bold text-gray-700 mb-2 font-sans">School Name</label>
                        <input
                          type="text"
                          value={newChildData.schoolInfo.schoolName}
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          <label className="block text-sm font-bold text-gray-700 mb-2 font-sans">Grade</label>
                          <input
                            type="text"
                            value={newChildData.schoolInfo.grade}
                            onChange={(e) => handleInputChange('schoolInfo.grade', e.target.value)}
                            className="w-full border-2 border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#CB748E] focus:border-transparent font-sans"
                        ...
                        <div>
                          <label className="block text-sm font-bold text-gray-700 mb-2 font-sans">Teacher Name</label>
                          <input
                            type="text"
                            value={newChildData.schoolInfo.teacherName}
                            onChange={(e) => handleInputChange('schoolInfo.teacherName', e.target.value)}
                            className="w-full border-2 border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#CB748E] focus:border-transparent font-sans"
                      ...
                      <div>
                        <label className="block text-sm font-bold text-gray-700 mb-2 font-sans">Special Services</label>
                        <div className="flex flex-wrap gap-2 mb-3">
                          {newChildData.schoolInfo.specialServices.map((service, index) => (
                            <div key={index} className="flex items-center px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm font-semibold font-sans">
                              <span>{service}</span>
                              <button
                                onClick={() => removeFromArray('schoolInfo.specialServices', index)}
                                className="ml-2 text-red-500 hover:text-red-700"
                              >
                                <X className="h-3 w-3" />
                              </button>
                        ...
                        <div className="flex space-x-2">
                          ...
                          <button
                            onClick={() => addToArray('schoolInfo.specialServices', newSpecialService, setNewSpecialService)}
                            className="px-4 py-2 bg-[#698a60] text-white rounded-xl hover:bg-green-700 transition-colors"
                          >
                            <Plus className="h-4 w-4" />
                          </button>
                  ...
                  <div className="bg-white border border-gray-200 rounded-2xl p-6">
                    ...
                    <div className="space-y-4">
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          <label className="block text-sm font-bold text-gray-700 mb-2 font-sans">Birth Weight</label>
                          <input
                            type="text"
                            value={newChildData.developmentalHistory.birthWeight}
                            onChange={(e) => handleInputChange('developmentalHistory.birthWeight', e.target.value)}
                            className="w-full border-2 border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#CB748E] focus:border-transparent font-sans"
                            placeholder="7 lbs 2 oz"
                          />
                        </div>
                        
                        <div>
                          <label className="block text-sm font-bold text-gray-700 mb-2 font-sans">Gestational Age</label>
                          <input
                            type="text"
                            value={newChildData.developmentalHistory.gestationalAge}
                            onChange={(e) => handleInputChange('developmentalHistory.gestationalAge', e.target.value)}
                            className="w-full border-2 border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#CB748E] focus:border-transparent font-sans"
                            placeholder="40 weeks"
                          />
                        </div>
                      </div>
                      
                      <div>
                        <label className="block text-sm font-bold text-gray-700 mb-2 font-sans">Birth Complications</label>
                        <textarea
                          value={newChildData.developmentalHistory.complications}
                          onChange={(e) => handleInputChange('developmentalHistory.complications', e.target.value)}
                          rows={3}
                          className="w-full border-2 border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#CB748E] focus:border-transparent resize-none font-sans"
                          placeholder="Any complications during birth or early development..."
                        />
                      </div>
                      
                      <div>
                        <h4 className="font-bold text-gray-700 mb-3 font-sans">Developmental Milestones</h4>
                        <div className="grid md:grid-cols-3 gap-4">
                          <div>
                            <label className="block text-xs font-bold text-gray-600 mb-1 font-sans">First Words</label>
                            <input
                              type="text"
                              value={newChildData.developmentalHistory.milestones.firstWords}
                              onChange={(e) => handleInputChange('developmentalHistory.milestones.firstWords', e.target.value)}
                          ...
                          <div>
                            <label className="block text-xs font-bold text-gray-600 mb-1 font-sans">Walking</label>
                            <input
                              type="text"
                              value={newChildData.developmentalHistory.milestones.walking}
                              onChange={(e) => handleInputChange('developmentalHistory.milestones.walking', e.target.value)}
                              className="w-full border-2 border-gray-300 rounded-xl px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#CB748E] focus:border-transparent font-sans"
                          ...
                          <div>
                            <label className="block text-xs font-bold text-gray-600 mb-1 font-sans">Potty Trained</label>
                            <input
                              type="text"
                              value={newChildData.developmentalHistory.milestones.pottyTrained}
                              onChange={(e) => handleInputChange('developmentalHistory.milestones.pottyTrained', e.target.value)}
                              className="w-full border-2 border-gray-300 rounded-xl px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#CB748E] focus:border-transparent font-sans"
                              placeholder="3 years"
                            />
                          </div>
                  ...
                  <div className="bg-white border border-gray-200 rounded-2xl p-6">
                    <h3 className="text-xl font-bold text-gray-800 mb-6 font-handwritten flex items-center">
                      <Target className="h-5 w-5 mr-2 text-[#CB748E]" />
                      Goals & Concerns
                    </h3>
                    
                    <div className="space-y-4">
                      <div>
                        <label className="block text-sm font-bold text-gray-700 mb-2 font-sans">Current Concerns</label>
                        <textarea
                          value={newChildData.currentConcerns}
                          onChange={(e) => handleInputChange('currentConcerns', e.target.value)}
                          rows={3}
                          className="w-full border-2 border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#CB748E] focus:border-transparent resize-none font-sans"
                          placeholder="Describe your current concerns about your child's development..."
                        />
                      </div>
                      
                      <div>
                        <label className="block text-sm font-bold text-gray-700 mb-2 font-sans">Therapy Goals</label>
                        <div className="flex flex-wrap gap-2 mb-3">
                          {newChildData.goals.map((goal, index) => (
                            <div key={index} className="flex items-center px-3 py-1 bg-yellow-100 text-yellow-800 rounded-full text-sm font-semibold font-sans">
                              <span>{goal}</span>
                              <button
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          rows={4}
                          className="w-full border-2 border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#CB748E] focus:border-transparent resize-none font-sans"
                          placeholder="Any additional information about your child that might be helpful for therapists..."
                        />
                      </div>
                    </div>
                  </div>
