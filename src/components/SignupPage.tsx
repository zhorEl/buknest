      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white bg-opacity-80 backdrop-blur-sm rounded-3xl shadow-lg p-8 border border-white border-opacity-50">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border-2 border-green-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-transparent bg-white shadow-sm font-readable"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full pl-10 pr-12 py-3 border-2 border-green-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-transparent bg-white shadow-sm font-readable"
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-pink-400 to-green-500 text-white px-8 py-4 rounded-2xl font-bold text-lg hover:from-pink-500 hover:to-green-600 transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center font-handwritten"
            >
              Create Account
          ...
          <div className="mt-6 text-center">
            <div className="bg-green-50 bg-opacity-70 backdrop-blur-sm rounded-2xl p-4 border border-green-200">
